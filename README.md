...
![CTF](https://img.shields.io/badge/CTF-Challenges-red?style=flat-square)
...
Python • Tkinter • Cryptography • Steganography

- Securely embeds files into images
- Supports hiding and extracting different file types
- Password-protected extraction

[View Project](https://github.com/Kumarh4x/stegoshield)

### 🤖 SDIT TechBot
**AI-Powered College Assistant**

Next.js • React • TypeScript • Tailwind CSS • RAG • BGE-M3 • OmniRoute

- AI-powered college assistant using RAG and semantic search
- Bilingual support
- Conversation memory
- Source citations

[View Project](https://github.com/Kumarh4x/college-assistent2026)
...
- Backend Developer
- Worked on a College Management Portal
- Backend functionality and database integration
- Next.js • Firebase • MongoDB • JavaScript • Tailwind CSS
